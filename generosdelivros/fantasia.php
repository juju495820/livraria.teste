...
<body>
  <div class="protudo">
    ...
    <div class="protudo_info">
      <h2><?php echo "Harry Potter e a Pedra Filosofal"; ?></h2>
...
<body>
  <div class="protudo">
    <img class="protudo_img" src="foto3.jpg">
    <div class="protudo_info">
      <h2><?php echo "Harry Potter e o Enigma do Príncipe"; ?></h2>
      <p class="protudo_preço"><?php echo "R$ 30,00"; ?></p>
      
      <p class="protudo_descrição"><?php echo "Harry Potter e o enigma do príncipe' dá continuidade à saga do jovem bruxo Harry Potter a partir do ponto em que o livro anterior parou o momento em que fica provado que o poder de Voldemort e dos Comensais da Morte, seus seguidores, cresce mais a cada dia, em meio à batalha entre o bem e o mal. A onda de terror provocada pelo Lorde das Trevas estaria afetando, até mesmo, o mundo dos trouxas (nãobruxos), e sendo agravada pela ação dos dementadores, criaturas mágicas aterrorizantes que 'sugam' a esperança e a felicidade das pessoas."?></p>

      <form method="POST" action="carrinho.php">
        <input type="hidden" name="protudo" value="<?php echo "Harry Potter e o Enigma do Príncipe"; ?>">
        <input type="hidden" name="preço" value="<?php echo "R$ 30,00"; ?>">
       <br> <button class="add-to-cart-btn" type="submit">adicionar ao carrinho </button>
      </form>
    </div>
