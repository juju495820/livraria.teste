...
<header>
    ...
    <a href="#" class="logo"><img src="logo1.png" width="200px" ></a>
    <nav class="navbar">
...
<body>
  <div class="protudo">
    ...
    <div class="protudo_info">
      <h2><?php echo "Engma o pricepe"; ?></h2>
      ...
      <form method="POST" action="carrinho.php">
        <input type="hidden" name="protudo" value="<?php echo "Harry Potter Engima do Pricípe"; ?>">
        <input type="hidden" name="preço" value="<?php echo "R$ 34,00"; ?>">
